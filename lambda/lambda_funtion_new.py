...
logging.basicConfig(filename='example.log', level=logging.INFO, format=LOG_FORMAT, datefmt='%m/%d/%Y %I:%M:%S %p')
...
def lambda_handler(node):
    ...
    logger.info("Recieved a request to evict node {}".format(node))
